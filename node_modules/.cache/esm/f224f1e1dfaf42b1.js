"main";(function (global, factory) {
    ...
    function toPromise(observable) {
        ...
        return new Promise(function (resolve, reject) {
            observable.subscribe({
                next: function (data) {
                    if (completed) {
                        _dfa‍.g.console.warn("Promise Wrapper does not support multiple results from Observable");
                    }
                    else {
                        completed = true;
                        resolve(data);
    ...
    var concat = function (first, second) {
        ...
        if (isTerminating(firstLink)) {
            _dfa‍.g.console.warn(new LinkError("You are calling concat on a terminating link, which will have no effect", firstLink));
            return firstLink;
        }
