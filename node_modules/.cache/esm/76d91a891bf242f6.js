"main";_1bf‍.x([["ResidentAPI",()=>ResidentAPI],["ReportsAPI",()=>ReportsAPI],["TransactionAPI",()=>TransactionAPI],["EmployeeAPI",()=>EmployeeAPI],["NursingHomesAPI",()=>NursingHomesAPI]]);let RESTDataSource;_1bf‍.w("apollo-datasource-rest",[["RESTDataSource",["RESTDataSource"],function(v){RESTDataSource=v}]]);yield;
...
const axios = require('axios')
    ...
    async getANursingHome(idNumber) {
        const result = await this.get('nursinghomes'+idNumber);
