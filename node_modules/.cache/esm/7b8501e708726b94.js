"main";(function (global, factory) {
        ...
        test: function (directive) {
            ...
            if (willRemove) {
                if (!directive.arguments ||
                    ...
                    _087‍.g.console.warn('Removing an @connection directive even though it does not have a key. ' +
    ...
    function tryFunctionOrLogError(f) {
        try {
            ...
            if (_087‍.g.console.error) {
                _087‍.g.console.error(e);
            }
        }
    }
    ...
    function warnOnceInDevelopment(msg, type) {
        ...
        if (!haveWarned[msg]) {
            ...
            switch (type) {
                case 'error':
                    _087‍.g.console.error(msg);
                    break;
                default:
                    _087‍.g.console.warn(msg);
            }
        }
    }
