"main";let ApolloServer,gql;_61a‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI;_61a‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}]]);yield;
...
server.listen().then(({ url }) => {
    _61a‍.g.console.log(`🚀 Server ready at ${url}`);
});
