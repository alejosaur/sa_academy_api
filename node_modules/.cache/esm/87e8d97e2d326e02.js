"main";let ApolloServer,gql;_2d3‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI,ReportsAPI,TransactionAPI;_2d3‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}],["ReportsAPI",["ReportsAPI"],function(v){ReportsAPI=v}],["TransactionAPI",["TransactionAPI"],function(v){TransactionAPI=v}]]);yield;
...
const resolvers = {
    ...
    Transaction: {
        type_transaction: ({ type_transation_id }) => dataSources.TransactionAPI.getATransaction(type_transation_id),
    }
};
...
server.listen().then(({ url }) => {
    _2d3‍.g.console.log(`🚀 Server ready at ${url}`);
});
