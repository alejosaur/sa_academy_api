"main";let ApolloServer,gql;_617‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI,ReportsAPI;_617‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}],["ReportsAPI",["ReportsAPI"],function(v){ReportsAPI=v}]]);yield;
...
server.listen().then(({ url }) => {
    _617‍.g.console.log(`🚀 Server ready at ${url}`);
});
