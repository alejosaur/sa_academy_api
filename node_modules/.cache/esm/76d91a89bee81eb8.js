"main";_bee‍.x([["ResidentAPI",()=>ResidentAPI],["ReportsAPI",()=>ReportsAPI],["TransactionAPI",()=>TransactionAPI]]);let RESTDataSource;_bee‍.w("apollo-datasource-rest",[["RESTDataSource",["RESTDataSource"],function(v){RESTDataSource=v}]]);yield;
...
const axios = require('axios')
    ...
    async createAResident(args) {
        ...
        .then((res) => {
            _bee‍.g.console.log(`statusCode: ${res.statusCode}`)
            _bee‍.g.console.log(res)
        })
        .catch((error) => {
            _bee‍.g.console.error(error)
        })
