"main";let ApolloServer,gql;_027‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let CoursesAPI;_027‍.w("./datasource",[["CoursesAPI",["CoursesAPI"],function(v){CoursesAPI=v}]]);
...
server.listen().then(({ url }) => {
    _027‍.g.console.log(`🚀 Server ready at ${url}`);
});
