"main";let ApolloServer,gql;_fab‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI,ReportsAPI;_fab‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}],["ReportsAPI",["ReportsAPI"],function(v){ReportsAPI=v}]]);yield;
...
const resolvers = {
    ...
    Report: {
        reports(report_type){
            return find(reports, { id: args.id });
        }
    },
    Resident: {
...
server.listen().then(({ url }) => {
    _fab‍.g.console.log(`🚀 Server ready at ${url}`);
});
