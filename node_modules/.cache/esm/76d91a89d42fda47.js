"main";_d42‍.x([["ResidentAPI",()=>ResidentAPI],["ReportsAPI",()=>ReportsAPI],["TransactionAPI",()=>TransactionAPI]]);let RESTDataSource;_d42‍.w("apollo-datasource-rest",[["RESTDataSource",["RESTDataSource"],function(v){RESTDataSource=v}]]);yield;
...
const axios = require('axios')
    ...
    async createAResident(args) {
        ...
        axios.post(this.baseURL+'residents', {
            name: 'Ancianos'
        })
        .then((res) => {
            _d42‍.g.console.log(`statusCode: ${res.statusCode}`)
            _d42‍.g.console.log(res)
        })
        .catch((error) => {
            _d42‍.g.console.error(error)
        })
