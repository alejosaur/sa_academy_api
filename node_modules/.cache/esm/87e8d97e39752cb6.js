"main";let ApolloServer,gql;_397‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI,ReportsAPI,TransactionAPI;_397‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}],["ReportsAPI",["ReportsAPI"],function(v){ReportsAPI=v}],["TransactionAPI",["TransactionAPI"],function(v){TransactionAPI=v}]]);yield;
...
const resolvers = {
    ...
    Mutation: {
        newResident: (root, { idNumber }, { dataSources }) => dataSources.ResidentAPI.createAResident(idNumber),
    }
};
...
server.listen().then(({ url }) => {
    _397‍.g.console.log(`🚀 Server ready at ${url}`);
});
