"main";_41b‍.x([["ResidentAPI",()=>ResidentAPI],["ReportsAPI",()=>ReportsAPI],["TransactionAPI",()=>TransactionAPI]]);let RESTDataSource;_41b‍.w("apollo-datasource-rest",[["RESTDataSource",["RESTDataSource"],function(v){RESTDataSource=v}]]);yield;
...
const http = require('http')
  ...
  async createAResident(args) {
      ...
      const req = http.request(options, (res) => {
        _41b‍.g.console.log(`statusCode: ${res.statusCode}`)
      ...
      req.on('error', (error) => {
        _41b‍.g.console.error(error)
      })

      req.write(data)
      req.on('response', res => {
          res.on('data', function (chunk) {
            context.return (chunk.toString('utf8'));
          });
      });
      req.end()
