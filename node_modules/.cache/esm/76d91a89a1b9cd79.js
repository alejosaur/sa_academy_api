"main";_a1b‍.x([["ResidentAPI",()=>ResidentAPI],["ReportsAPI",()=>ReportsAPI],["TransactionAPI",()=>TransactionAPI]]);let RESTDataSource;_a1b‍.w("apollo-datasource-rest",[["RESTDataSource",["RESTDataSource"],function(v){RESTDataSource=v}]]);yield;
...
const http = require('http')
  ...
  async createAResident(args) {
      ...
      const req = http.request(options, (res) => {
        _a1b‍.g.console.log(`statusCode: ${res.statusCode}`)
