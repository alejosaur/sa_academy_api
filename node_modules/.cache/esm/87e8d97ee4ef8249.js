"main";let ApolloServer,gql;_e4e‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI,ReportsAPI,TransactionAPI;_e4e‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}],["ReportsAPI",["ReportsAPI"],function(v){ReportsAPI=v}],["TransactionAPI",["TransactionAPI"],function(v){TransactionAPI=v}]]);yield;
...
const resolvers = {
    ...
    Transaction: {
        type_transaction: ({ type_transaction_id }) => type_transaction_id,
    }
};
...
server.listen().then(({ url }) => {
    _e4e‍.g.console.log(`🚀 Server ready at ${url}`);
});
