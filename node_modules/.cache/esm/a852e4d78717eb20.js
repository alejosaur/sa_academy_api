...
function mergeSchemas(_a) {
    ...
    if (onTypeConflict) {
        _871‍.g.console.warn('`onTypeConflict` is deprecated. Use schema transforms to customize merging logic.');
...
function mergeSchemasImplementation(_a) {
    ...
    if (!resolvers) {
        ...
        _871‍.g.console.warn('Passing functions as resolver parameter is deprecated. Use `info.mergeInfo` instead.');
...
function createMergeInfo(allSchemas, fragments) {
    return {
        delegate: function (operation, fieldName, args, context, info, transforms) {
            _871‍.g.console.warn('`mergeInfo.delegate` is deprecated. ' +
