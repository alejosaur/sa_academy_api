"main";let ApolloServer,gql;_898‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let MvrpAPI;_898‍.w("./datasource",[["MvrpAPI",["MvrpAPI"],function(v){MvrpAPI=v}]]);yield;
...
server.listen().then(({ url }) => {
  _898‍.g.console.log(`🚀 Server ready at ${url}`);
});
