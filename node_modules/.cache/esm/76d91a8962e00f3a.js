"main";_62e‍.x([["ResidentAPI",()=>ResidentAPI],["ReportsAPI",()=>ReportsAPI],["TransactionAPI",()=>TransactionAPI]]);let RESTDataSource;_62e‍.w("apollo-datasource-rest",[["RESTDataSource",["RESTDataSource"],function(v){RESTDataSource=v}]]);yield;
  ...
  async createAResident(idNumber) {
    const result = await this.get('residents/'+idNumber);
