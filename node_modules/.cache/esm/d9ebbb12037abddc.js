"main";let ApolloServer,gql;_037‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI,ReportsAPI,TransactionAPI,EmployeeAPI,NursingHomesAPI;_037‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}],["ReportsAPI",["ReportsAPI"],function(v){ReportsAPI=v}],["TransactionAPI",["TransactionAPI"],function(v){TransactionAPI=v}],["EmployeeAPI",["EmployeeAPI"],function(v){EmployeeAPI=v}],["NursingHomesAPI",["NursingHomesAPI"],function(v){NursingHomesAPI=v}]]);yield;
...
const typeDefs = gql`
    ...
    type Mutation {
        newResident(    credits: int
                        name: String
                        professor: String): Resident

        editResident(   code: ID!
                        credits: int
                        name: String
                        professor: String): Resident
...
server.listen().then(({ url }) => {
    _037‍.g.console.log(`🚀 Server ready at ${url}`);
});
