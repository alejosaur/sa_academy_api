"main";let ApolloServer,gql;_7f2‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI,ReportsAPI,TransactionAPI;_7f2‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}],["ReportsAPI",["ReportsAPI"],function(v){ReportsAPI=v}],["TransactionAPI",["TransactionAPI"],function(v){TransactionAPI=v}]]);yield;
...
const resolvers = {
    Query: {
        ...
        report_type: (root, args, { dataSources }) => dataSources.ReportsAPI.getAType(idNumber),
...
server.listen().then(({ url }) => {
    _7f2‍.g.console.log(`🚀 Server ready at ${url}`);
});
