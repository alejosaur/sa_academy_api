"main";let ApolloServer,gql;_1ba‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let CoursesAPI;_1ba‍.w("./datasource",[["CoursesAPI",["CoursesAPI"],function(v){CoursesAPI=v}]]);
...
server.listen().then(({ url }) => {
    _1ba‍.g.console.log(`🚀 Server ready at ${url}`);
});
