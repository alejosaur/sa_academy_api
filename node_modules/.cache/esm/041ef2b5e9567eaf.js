"main";let ApolloServer,gql;_e95‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI;_e95‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}]]);yield;
...
server.listen().then(({ url }) => {
    _e95‍.g.console.log(`🚀 Server ready at ${url}`);
});
