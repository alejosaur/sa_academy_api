"main";_472‍.x([["ResidentAPI",()=>ResidentAPI],["ReportsAPI",()=>ReportsAPI],["TransactionAPI",()=>TransactionAPI]]);let RESTDataSource;_472‍.w("apollo-datasource-rest",[["RESTDataSource",["RESTDataSource"],function(v){RESTDataSource=v}]]);yield;
...
const axios = require('axios')
    ...
    async createAResident(args) {
        ...
        .then((res) => {
            _472‍.g.console.log(`statusCode: ${res.statusCode}`)
            _472‍.g.console.log(res)
        })
        .catch((error) => {
            _472‍.g.console.error(error)
        })
