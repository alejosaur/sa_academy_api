"main";let ApolloServer,gql;_76c‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI;_76c‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}]]);yield;
...
server.listen().then(({ url }) => {
    _76c‍.g.console.log(`🚀 Server ready at ${url}`);
});
