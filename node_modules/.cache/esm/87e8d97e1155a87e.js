"main";let ApolloServer,gql;_115‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI,ReportsAPI,TransactionAPI;_115‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}],["ReportsAPI",["ReportsAPI"],function(v){ReportsAPI=v}],["TransactionAPI",["TransactionAPI"],function(v){TransactionAPI=v}]]);yield;
...
const typeDefs = gql`
    ...
    type Mutation {
        ...
        editResident(newResident(identity_document: Int
                    name: String!
                    birth_date: String!
                    admission_date: String!
                    gender: String!
...
server.listen().then(({ url }) => {
    _115‍.g.console.log(`🚀 Server ready at ${url}`);
});
