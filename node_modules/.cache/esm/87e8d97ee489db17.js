"main";let ApolloServer,gql;_e48‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI,ReportsAPI,TransactionAPI;_e48‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}],["ReportsAPI",["ReportsAPI"],function(v){ReportsAPI=v}],["TransactionAPI",["TransactionAPI"],function(v){TransactionAPI=v}]]);yield;
...
const typeDefs = gql`
    ...
    type Report {
        id: ID!
        report_type(report_type_id): [Report_type]
        created_at: String
        IP: String
    }
...
server.listen().then(({ url }) => {
    _e48‍.g.console.log(`🚀 Server ready at ${url}`);
});
