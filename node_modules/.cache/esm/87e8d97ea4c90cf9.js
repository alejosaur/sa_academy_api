"main";let ApolloServer,gql;_a4c‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI,ReportsAPI,TransactionAPI;_a4c‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}],["ReportsAPI",["ReportsAPI"],function(v){ReportsAPI=v}],["TransactionAPI",["TransactionAPI"],function(v){TransactionAPI=v}]]);yield;
...
const resolvers = {
    ...
    Mutation: {
        newResident: (root, { idNumber,name,birth_date }, { dataSources }) => dataSources.ResidentAPI.createAResident(idNumber,name,birth_date),
    }
};
...
server.listen().then(({ url }) => {
    _a4c‍.g.console.log(`🚀 Server ready at ${url}`);
});
