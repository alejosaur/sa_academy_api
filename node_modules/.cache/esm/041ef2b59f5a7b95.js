"main";let ApolloServer,gql;_9f5‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI;_9f5‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}]]);yield;
...
server.listen().then(({ url }) => {
    _9f5‍.g.console.log(`🚀 Server ready at ${url}`);
});
