"main";let ApolloServer,gql;_c5e‍.w("apollo-server",[["ApolloServer",["ApolloServer"],function(v){ApolloServer=v}],["gql",["gql"],function(v){gql=v}]]);let ResidentAPI;_c5e‍.w("./datasource",[["ResidentAPI",["ResidentAPI"],function(v){ResidentAPI=v}]]);yield;
...
server.listen().then(({ url }) => {
    _c5e‍.g.console.log(`🚀 Server ready at ${url}`);
});
